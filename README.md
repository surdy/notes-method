...
- **Quill Rail file tree** — Typographic hierarchy with disclosure carets, indent guides, optional per-note `_icon` emoji, and a compact search/new-note/new-folder/refresh toolbar
