...
- Delegated online-meeting resolution is incomplete but not limited to meetings organized by the signed-in user. Some other-organized series resolve and some return empty responses; organizer domain, recurrence, and audience did not distinguish them, so connector failures remain visible and isolated per series.
