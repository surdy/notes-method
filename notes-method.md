...
- Reading View and Live Preview should syntax-highlight fenced code blocks when the fence declares a supported language. Unsupported or unlabeled fences should remain escaped plain code.
